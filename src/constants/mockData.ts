  ...
  projects: [
    {
      ...
      url: 'https://challenge-12-jm-arkevin.vercel.app/',
    },
    {
      id: '2',
      title: 'Portfolio 2',
      ...
      url: 'https://challenge-11-jm-arkevin.vercel.app/',
    },
    {
      id: '3',
      title: 'Portfolio 3',
      ...
      url: 'https://challenge-9-jm-arkevin.vercel.app/',
    },
  ] as Project[],
};
  ...
  testimonials: [
    {
      id: '1',
      quote:
        "Working with Jesse Markevin was a smooth experience from start to finish. He translated our design into clean, responsive code and even suggested improvements we hadn't thought of. Highly recommended!",
      author: {
        name: 'Sarah Tan',
    ...
    },
    {
      id: '2',
      quote:
        'Jesse delivered beyond expectations. The codebase is clean, maintainable, and the UI matches our Figma designs perfectly across breakpoints.',
      author: {
        name: 'Liam Brooks',
...
export const socialLinks = [
  {
    name: 'Facebook',
    href: 'https://www.facebook.com/jesse.markevin',
    icon: 'facebook',
  },
  {
    name: 'Instagram',
    href: 'https://www.instagram.com/jessemarkevin/',
    icon: 'instagram',
  },
  {
    name: 'LinkedIn',
    href: 'https://www.linkedin.com/in/jesse-markevin-90075315b/',
    icon: 'linkedin',
  },
...
export const footerData = {
  copyright: '© 2023 Jesse Markevin. All rights reserved.',
  socialLinks,
};
